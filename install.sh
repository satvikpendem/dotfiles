...
cargo_packages="bat cargo-audit cargo-cmd cargo-cranky cargo-do cargo-edit cargo-nextest cargo-tarpaulin cargo-watch exa fnm hyperfine git-delta skim starship tealdeer xh zoxide"
